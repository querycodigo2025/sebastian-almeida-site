...
const videos = [
  {
    ...
    title: 'Reconexão Emocional',
    desc: 'Transformação após o Workshop Reconexão Emocional',
  ...
  },
  {
    ...
    desc: 'Resultado real da Mentoria Cicatrização Emocional',
    poster: '/images/immersion.jpg',
  },
  {
    id: 3,
    src: '/videos/depoimento3.mp4',
    title: 'Método Query na Prática',
    desc: 'Como o Método Query transformou minha vida',
    poster: '/images/audience-stage.jpg',
  },
  {
    id: 4,
    src: '/videos/depoimento4.mp4',
    title: 'Imersão Águia de Fogo',
    desc: 'Experiência na imersão de renascimento emocional',
    ...
    <div className={`rounded-sm overflow-hidden border transition-all duration-300 ${
      ...
      <div className="relative" style={{ aspectRatio: '9/16', maxHeight: '480px' }}>
        ...
        {!isActive && (
          <button
            ...
            aria-label={`Assistir depoimento: ${video.title}`}
          >
      ...
      <div className="p-4 space-y-1">
        <div className="flex items-center gap-2">
          ...
          <p className="text-gold text-xs uppercase tracking-widest font-semibold">Depoimento</p>
        </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-4 mb-5">
            ...
            <span className="text-gold text-xs uppercase tracking-[0.3em] font-semibold">Depoimentos</span>
            <div className="h-px w-12 bg-gold" />
          </div>
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-white mb-4">
            Vidas <span className="gold-text">Transformadas</span>
          </h2>
          <p className="text-white/55 max-w-xl mx-auto text-lg">
            Assista aos depoimentos reais de pessoas que passaram pelos programas
            de Sebastian Almeida e mudaram completamente sua realidade emocional.
          </p>
        </div>
        ...
        <div className="mt-14 text-center space-y-5">
          <p className="font-serif text-2xl md:text-3xl text-white font-bold">
            Você pode ser a próxima <span className="gold-text">história de transformação</span>
          </p>
          <a
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá Sebastian! Vi os depoimentos no site e quero iniciar minha transformação emocional.')}`}
            target="_blank"

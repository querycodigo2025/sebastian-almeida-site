...
export default function About() {
  return (
    ...
    >
      ...
      {/* ── 1. BANNER DO TOPO (Visual Super Premium com Recorte de Sebastian) ── */}
      <div 
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 w-full h-full flex items-center z-20">
          <div className="grid md:grid-cols-12 gap-6 items-center w-full h-full">
            ...
            {/* Right side: Large Transparent Cutout of Sebastian rising from the bottom */}
            <div className="md:col-span-5 h-full flex items-end justify-center md:justify-end relative">
              <div className="relative h-[85%] aspect-square md:h-[95%] md:w-auto drop-shadow-[0_20px_45px_rgba(0,0,0,0.85)] z-20">
                <img
                  src="/images/about-cutout.png"
                  alt="Sebastian Almeida retrato recortado"
      ...
      {/* ── 2. BIOGRAFIA & FOTO PEQUENA DO LADO DIREITO (Sem fundo branco, cores reais) ── */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-20 pb-14">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Small transparent cutout photo floating on the right side of the biography */}
      ...
      {/* ── 3. DUAS FOTOS DESTAQUE (Preservando as fotos originais em proporção perfeita) ── */}

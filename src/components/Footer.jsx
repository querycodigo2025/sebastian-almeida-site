      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-white/40 text-sm mt-1 uppercase tracking-widest">
                {t('hero.badge.role')} · {t('hero.badge.creator')} {t('mq.title')}
              </p>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-9 h-9 rounded-sm flex items-center justify-center flex-shrink-0"
                  style={{ background: 'rgba(193, 53, 132, 0.12)', border: '1px solid rgba(193, 53, 132, 0.25)' }}>
                ...
                <span className="text-sm">@sebastianalmeidamentor</span>
              </a>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-sm">
            © {currentYear} Sebastian Almeida. {t('foot.rights')}
          </p>
